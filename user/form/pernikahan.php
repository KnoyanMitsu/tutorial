...
<?php @include 'header.php'?>
    <div class="container">
    <h1 class="text-center">Lanjutkan Isi Form Pernikahan</h1>
    ...
    <form method="post" enctype="multipart/form-data">
                            <div class="form-group form-float ">
                                ...
                                <label class="form-label">Judul</label>
                                    <input type="text" name="judul" class="form-control email mb-2" >                               
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm">
                            ...
                            <div class="col-sm">
                                <h4 class="text-center"><strong>Mempelai Pria</strong></h4>
                            </div>
                                <div class="col-sm">
                                <hr style="border-top: 1px solid rgba(0, 0, 0);">
                                </div>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm">
                                <h4 class="text-center"><strong>Mempelai Wanita</strong></h4>
                            </div>
                                <div class="col-sm">
                                <hr style="border-top: 1px solid rgba(0, 0, 0);">
                                </div>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm">
                                <h4 class="text-center"><strong>Akad</strong></h4>
                            </div>
                                <div class="col-sm">
                                <hr style="border-top: 1px solid rgba(0, 0, 0);">
                                </div>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm">
                                <h4 class="text-center"><strong>Resepsi</strong></h4>
                            </div>
                                <div class="col-sm">
                                <hr style="border-top: 1px solid rgba(0, 0, 0);">
                                </div>
